      ...
      <div className="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-yellow-100/20 pt-4">
        ...
        <div className="mx-auto max-w-7xl pb-8 sm:py-12 lg:px-8">
          ...
          <p>
            ...
            nuestro sitio web utiliza Cookies propias y de terceros. Como
            Usuario de nuestro sitio web, le informamos que utilizamos cookies
            y/o tecnologías similares (en adelante cookies) que almacenan y
            ...
            navegación, enviarle publicidad o personalizar la forma en que se
            muestra el contenido. A continuación, le detallamos los diferentes
          ...
          <ul role="list" className="space-y-8 mt-10 text-gray-600">
            <li>
              ...
              <div className="flex gap-x-3">
                ...
                <span>
                  ...
                  <p>
                    Permiten controlar el tráfico de datos, identificar la
                    sesión, realizar compras, realizar solicitudes, utilizar
                    elementos de seguridad durante la navegación, almacenar
                    contenidos para visualización de videos o sonido o compartir
                    contenidos mediante las redes sociales.
                  </p>
                </span>
              </div>
              <div className="flex gap-x-3 mt-2">
                ...
                <span>
                  ...
                  <p>
                    ...
                    para la medición de la actividad del sitio web y para
                    elaborar perfiles de navegación de los usuarios, con la
                    finalidad de ofrecer mejoras de uso para los usuarios.
                  </p>
                </span>
              </div>
              ...
              <div className="flex gap-x-3 mt-2">
                ...
                <span>
                  ...
                  <p>
                    ...
                    Twitter, Pinterest, Instagram, etc.). Su función es
                    controlar la interacción con los widgets sociales dentro del
                    sitio web.
                  </p>
                </span>
              </div>
              ...
              <div className="flex gap-x-3">
                ...
                <span>
                  ...
                  <p>
                    ...
                    sesión no quedan almacenadas en el dispositivo informático
                    del usuario.
                  </p>
                </span>
              </div>
              <div className="flex gap-x-3 mt-2">
                ...
                <span>
                  ...
                  <p>
                    ...
                    proporcionada puede ser tratada cuando el usuario abandona
                    el sitio web y cuando vuelva a conectarse de nuevo. Estas
                    cookies pueden ser eliminadas en cualquier momento por el
                    usuario.
                  </p>
                </span>
              </div>
              ...
              <div className="flex gap-x-3">
                ...
                <span>
                  ...
                  <p>
                    ...
                    del usuario desde el sistema informático propiedad del
                    titular del sitio web, desde donde se ha realizado la
                    solicitud, prestado el servicio o realizado una compra.
                  </p>
                </span>
              </div>
              <div className="flex gap-x-3 mt-2">
                ...
                <span>
                  ...
                  <p>
                    ...
                    tercera autorizada o contratada por el titular del sitio
                    web, desde donde se ha realizado la solicitud, prestado el
                    servicio o realizado una compra. Debe saber que si acepta
                    las cookies de terceros, deberá eliminarlas desde las
                    opciones del navegador o desde el sistema ofrecido por el
                    propio tercero. A continuación le detallamos sitios que
                    podrá visitar para conocer mejor las cookies de terceros
                    (desactivación, posibles transferencias de datos a terceros
                    países, etc.): Google Chrome Mozilla Firefox Microsoft Edge
                    Chrome para Android Safari (Apple) Opera Firefox Así como
                    Google AdWords Si utiliza otros navegadores le recomendamos
                    consultar su política de uso y gestión de cookies. Le
                    informamos que si desactiva alguna de las cookies, la
                    herramienta de control dejará de funcionar con eficacia y
                    esto puede tener un efecto negativo en su experiencia de
            ...
            <li>
              ...
              <p>
                Como parte del deber de información del artículo 13.2 f) del
                RGPD, le comunicamos que en caso de realizar perfiles sobre su
                persona, le solicitaremos consentimiento previo. No obstante,
                debe saber que puede oponerse a ser objeto de una decisión
                automatizada de sus datos, donde se evalúen aspectos personales,
                como puede ser analizar o predecir aspectos relacionados con su
                rendimiento en el trabajo, situación económica, salud, las
                preferencias o intereses personales, fiabilidad o el
                comportamiento, de manera que a consecuencia de ello se
                produzcan efectos jurídicos sobre su persona o le afecte de una
                manera similar.
              </p>
              <p>
            ...
            <li>
              ...
              <p>
                ...
                En caso de cesiones a otras entidades o a otros países fuera de
                la Unión Europea, le informaremos y solicitaremos su
            ...
            <li>
              ...
              <p>
                Al pulsar libremente el botón ACEPTAR de la ventana informativa
                de cookies (banner o pop up), usted consiente expresamente el
                uso de cookies, aunque en cualquier momento puede cambiar de
                opinión y retirar su consentimiento.
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                Tiene derecho a conocer si nuestra entidad está tratando sus
                datos personales; por tanto, tiene derecho a acceder a sus
