...
//TODO: Other similar treatments at the bottom
// Buy cremas / Giftcards
// Form save into the DB and send mail
// Pull Images from Cloudinary
// Refactor names in the DB
      ...
      {treatmentError || !treatmentData ? (
        ...
        <>
          <div aria-hidden="true" className="relative">
            <Image
              src={treatmentData[0].images.main}
              alt=""
          ...
          <div className="relative max-w-7xl mx-auto -mt-12 pb-18 sm:px-6  lg:px-8">
            <div className="mx-auto max-w-2xl text-center lg:max-w-4xl">
              ...
              <h2 className="font-medium text-amber-400">
                {treatmentData[0].subtitle}
              </h2>
              <>
                {treatmentData[0].longDescription.map((description, index) => (
                  <p
            ...
            <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:max-w-none lg:grid-cols-3 lg:gap-x-8">
              <div className="border-t border-gray-200 pt-4">
                ...
                <dd className="mt-2 text-sm text-gray-500">
                  {treatmentData[0].properties.time}
                </dd>
              </div>
              <div className="border-t border-gray-200 pt-4">
                <dt className="font-medium text-gray-900">Anestesia</dt>
                <dd className="mt-2 text-sm text-gray-500">
                  {treatmentData[0].properties.anesthesia ? "Sí" : "No"}
                </dd>
              </div>
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <dd className="mt-2 text-sm text-gray-500">
                  {treatmentData[0].properties.populatedAreas?.map(
                    (area, index) => (
                      <Link
                        key={area.id + index}
                        onClick={scrollToTop}
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <dd className="mt-2 text-sm text-gray-500">
                  {treatmentData[0].properties.duration}
                </dd>
              </div>
              <div className="border-t border-gray-200 pt-4">
                <dt className="font-medium text-gray-900">
                ...
                <dd className="mt-2 text-sm text-gray-500">
                  {treatmentData[0].properties.resultsTime}
                </dd>
              </div>
              <div className="border-t border-gray-200 pt-4">
                ...
                <div className="-my-2">
                  <div className="relative box-content h-80 overflow-x-auto py-2 xl:overflow-visible">
                    <div className="absolute flex space-x-8">
                      {treatmentData[0].images.clients.map((image, index) => (
                        <div
          ...
          <div className="mx-auto max-w-7xl pt-16 pb-12 sm:px-6 sm:pb-12">
            <div className="mx-auto max-w-7xl divide-y divide-gray-900/10">
              ...
              <dl className="mt-6 space-y-4 divide-y divide-gray-900/10">
                {treatmentData[0].questions &&
                  treatmentData[0].questions?.map((faq, index) => (
                    <Disclosure
                      as="div"
          ...
          {treatmentData[0].relatedProducts && (
          ...
          {treatmentData[0].relatedTreatments && (
            <div className="mx-auto mt-8 max-w-7xl sm:mt-16 lg:px-6">
              ...
              <div className="mt-6 grid grid-cols-1 gap-x-8 gap-y-8 sm:px-4 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                {treatmentData[0].relatedTreatments.map(
