        ...
        <ul role="list" className="space-y-8 text-gray-600">
          <li className="flex gap-x-3">
            ...
            <span>
              ...
              <p className="mt-6">
                ...
                forma confidencial y quedarán incorporados a la correspondiente
                actividad de tratamiento titularidad de nuestra entidad.
              </p>
              <p className="mt-2">
                Solicitamos aquellos datos imprescindibles para atender su
                solicitud, facturar si realiza una compra o contratación o
                mantener la relación con su persona en caso de que lo solicite o
                cuando nos veamos obligados para poder prestarle los servicios
                y/o atender sus compras en este sitio web.
              </p>
            </span>
          </li>
          ...
          <li className="flex gap-x-3">
            ...
            <span>
              ...
              <p className="mt-6">
                ...
                nuestra web o solicitante de empleo. No enviamos publicidad sin
          ...
          <li className="flex gap-x-3">
            ...
            <span>
              ...
              <p className="mt-2">
                ...
                y/o contratación de nuestros servicios y/o compra de productos.
              </p>
              <p className="mt-2">
                El consentimiento libre, específico, informado e inequívoco,
                puesto que le informamos de la presente política de privacidad,
                que tras la lectura de esta y de estar conforme, puede aceptar
                mediante la marcación de las casillas dispuestas a tal efecto.
              </p>
              <p className="mt-2">
          ...
          <li className="flex gap-x-3">
            ...
            <span>
              ...
              <p className="mt-6">
                ...
                recaban y para determinar las posibles responsabilidades que se
                pudieran derivar de la finalidad.
              </p>
              <p className="mt-6">
          ...
          <li className="flex gap-x-3">
            ...
            <span>
              ...
              <p className="mt-6">
                No elaboramos perfiles utilizando sus datos personales, pero en
                el caso de hacerlo se le informará y solicitará permiso para
                hacerlo.
              </p>
              <p className="mt-6">
          ...
          <li className="flex gap-x-3">
            ...
            <span>
              ...
              <p className="mt-6">
                Sus datos personales no se cederán a otros países ni a entidades
                terceras salvo en los casos que exista una obligación legal.
              </p>
              <p className="mt-6">
                En caso de compra de productos o contratación de servicios, sus
                datos personales podrán ser cedidos a aquellas entidades
                necesarias para entregarle los productos adquiridos o prestarle
                nuestros servicios.
              </p>
              <p className="mt-6">
                ...
                necesarios para la ejecución de las contrataciones y/o compras.
              </p>
              <p className="mt-6">
