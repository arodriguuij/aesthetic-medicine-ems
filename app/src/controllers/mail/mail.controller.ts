...
export const sendMailReceipt = async (giftCards: GiftCardFormGet) => {
  ...
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      to: giftCards.email, // email receiver, // in case where you are sending onboarding emails, this field will be dynamic, it will be the email of the User
      subject: "Recibo tarjeta de regalo EMS",
      react: RecipeMail(giftCards), //using our custom react component to render email content/body
    });
