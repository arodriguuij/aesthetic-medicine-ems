...
const PaymentSuccess = () => {
  ...
  debugger
  if (
    giftCard200.length === 0 &&
    giftCard300.length === 0 &&
    giftCard500.length === 0
  )
    router.push("/");
      ...
      <>
        <div className="mx-auto sm:px-6  mb-8 lg:max-w-7xl lg:px-8">
          ...
          <div className="flex">
            ...
            <p className="ml-1 text-sm font-medium text-indigo-600 hover:text-indigo-500 sm:hidden"></p>
          </div>
        </div>
