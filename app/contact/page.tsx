  ...
  return (
    <div className="isolate mx-auto px-6 lg:px-8 items-center">
      ...
      <div className="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-amber-100/20 py-4">
        ...
        {/* <div className="mx-auto max-w-7xl text-center mt-8 sm:px-6 lg:px-8 justify-center	">
          {meetings.map((meeting, index) => (
            <li
              key={meeting.id + index}
              className="group flex items-center space-x-4 rounded-xl mt-4"
            >
              <div
                className={`h-5 w-5 flex-none rounded-full ${meeting.color}`}
              />
              <div
