    ...
    <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 justify-center ">
      ...
      <div className="mx-auto mt-8 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-4">
        <div>
          ...
          <a href="https://www.google.com/maps/place/Policl%C3%ADnica+Navalmoral+SL/@39.8949182,-5.545252,17z/data=!3m1!4b1!4m6!3m5!1s0xd3fd9ca964ee18d:0xd4044ef40795f356!8m2!3d39.8949141!4d-5.5426771!16s%2Fg%2F1tk8ddsz?entry=ttu">
